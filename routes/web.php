...
Route::get('/stock/{symbol}', [HomeController::class, 'stockView'])->middleware(['auth', 'verified', 'role:Admin'])->name('stock-view');
Route::get('/trigger-stock-event/{symbol}', [HomeController::class, 'triggerStockEvent'])->middleware(['auth', 'verified', 'role:Admin'])->name('trigger-stock-event');
