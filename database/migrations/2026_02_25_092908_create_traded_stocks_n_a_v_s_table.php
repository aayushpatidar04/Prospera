...
return new class extends Migration
{
    ...
    {
        Schema::create('traded_stocks_n_a_v_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->date('date');
            $table->unique(['identifier', 'symbol', 'series', 'marketType', 'date']);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('traded_stocks_n_a_v_s');
    }
};
